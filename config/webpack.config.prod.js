...
module.exports = {
  ...
  output: {
    ...
    // To resolve treating errors from different bundles as cross-origin
  ...
  module: {
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          // load GraphQL queries as raw text
          {
            test: /\.gql$/i,
            use: 'raw-loader',
          },
  ...
  plugins: [
    ...
    ('development' !== reactEnv && 'fv' !== target) &&
      new SentryCliPlugin({
        rewrite: true,
