...
import listenOrientationChange, { getScreenHeight } from '../../lib/utils/Orientation'
...
class Auth extends React.Component<Props> {
  componentDidMount() {
    listenOrientationChange(this.handleOrientationChange)
    log.info(goodWallet)
  }
