      ...
      subVerifierDetailsArray: [
        {
          ...
          verifier: config.torusNetwork === 'mainnet' ? 'google' : 'google-shubs', // old testnet verifier
          // verifier: config.torusNetwork === 'mainnet' ? 'google' : torusGoogleAuth0, // old testnet verifier
          jwtParams,
        },
      ],
    })
