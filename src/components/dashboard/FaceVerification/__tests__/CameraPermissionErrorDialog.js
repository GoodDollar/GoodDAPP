...
import ImportedCameraPermissionErrorDialog from '../components/CameraPermissionErrorDialog'

const ErrorScreen = withThemeProvider(ImportedCameraPermissionErrorDialog)
