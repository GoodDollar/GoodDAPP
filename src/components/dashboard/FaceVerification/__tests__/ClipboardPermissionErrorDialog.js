...
import ImportedClipboardPermissionErrorDialog from '../components/ClipboardPermissionErrorDialog'

const ErrorScreen = withThemeProvider(ImportedClipboardPermissionErrorDialog)
