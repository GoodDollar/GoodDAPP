...
export default function createAnimatableComponent(WrappedComponent) {
  ...
  return class AnimatableComponent extends Component {
    ...
    componentDidMount() {
      const { animation, duration, delay, onAnimationBegin, iterationDelay } = this.props
      if (animation) {
    ...
    UNSAFE_componentWillReceiveProps(props) {
      const { animation, delay, duration, easing, iterationDelay, transition, onAnimationBegin } = props
    ...
    transition(fromValues, toValues, duration, easing) {
      ...
      const { transitionValues, currentTransitionValues, transitionStyle } = this.getTransitionState(transitionKeys)
