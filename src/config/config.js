...
const Config = {
  ...
  learnUrl: env.REACT_APP_LEARN_URL || 'https://www.notion.so/gooddollar/GoodDollar-550f7d74c59c4123a7851fea52891811',
  useGdUrl: env.REACT_APP_USE_GD_URL || 'https://www.notion.so/gooddollar/Use-G-8639553aa7214590a70afec91a7d9e73',
  donateUrl: env.REACT_APP_DONATE_URL || 'https://www.notion.so/gooddollar/Donate-to-a-G-Cause-e7d31fb67bb8494abb3a7989ebe6f181',
  voteUrl: env.REACT_APP_VOTE_URL || 'https://www.notion.so/gooddollar/About-GoodDAO-a8568c97caec44968e6b6e96303d73ad',
  torusEnabled: env.REACT_APP_USE_TORUS === 'true',
  torusNetwork,
  deltaWallet: env.REACT_APP_DELTA_WALLET === 'true',
