...
const Config = {
  ...
  faceVerificationPrivacyUrl: process.env.REACT_APP_FV_LEARN_MORE_URL || 'https://medium.com/gooddollar/gooddollar-identity-pillar-balancing-identity-and-privacy-part-i-face-matching-d6864bcebf54',
