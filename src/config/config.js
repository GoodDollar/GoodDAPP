...
const Config = {
  ...
  receiveUrl: process.env.REACT_APP_RECEIVE_URL || `${publicUrl}/AppNavigation/Dashboard/Send?code`,
  sendUrl: process.env.REACT_APP_SEND_URL || `${publicUrl}/AppNavigation/Dashboard/Home?receive`,
  ethereum: {
    '42': {
      network_id: 42,
