...
const goodIdExplorerUrls = {
  CELO: env.REACT_APP_GOODID_CELO_EXPLORER ?? `https://api.etherscan.io/v2/api?chainid=42220&apikey=${env.REACT_APP_ETHERSCAN_KEY}`,
...
const ethereum = {
  '1': {
    ...
    explorerAPI: `https://api.etherscan.io/v2/api?chainid=1&apikey=${env.REACT_APP_ETHERSCAN_KEY}&`,
  ...
  '42': {
    ...
    explorer: `https://api.etherscan.io/v2/api?chainid=1&apikey=${env.REACT_APP_ETHERSCAN_KEY}&`,
    explorerName: 'etherscan',
  },
  '121': {
    ...fuseNetwork,
  ...
  '42220': {
    ...
    explorerAPI: `https://api.etherscan.io/v2/api?chainid=42220&apikey=${env.REACT_APP_ETHERSCAN_KEY},https://celo.blockscout.com/api`,
