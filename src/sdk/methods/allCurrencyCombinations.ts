 ...
 * @return {Promise<Array<[Currency, Currency]>>} List of pairs.
 */
export async function allCurrencyCombinations(chainId: SupportedChainId, currencyA?: Currency, currencyB?: Currency): Promise<Array<[Currency, Currency]>> {
  ...
  if (chainId === SupportedChainId.FUSE) {
    const [fuseTokens] = await getTokens(122)
